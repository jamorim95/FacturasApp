...
public class NovoProdutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Guardar novo produto", Snackbar.LENGTH_LONG)
                        .setAction("GUARDAR", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if(relacao!=null) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Produto guardado na base de dados !", Toast.LENGTH_SHORT).show();
    ...
    private void saveAllInfoToDatabase(RelacaoFacturaProduto relacao){
        ...
        mDatabase_produto.insert(ProdutoDbScheme.ProdutoTable.NAME, null, values_produto);
    ...
    private RelacaoFacturaProduto getRelacaoNovoProduto(){
        ...
        if(designacao.isEmpty() ||  comentario.isEmpty()  ||  categoria==0  ||  valor.isEmpty()){
            return null;
        }
    ...
    private void inicializarGlobalVars(){
        ...
        mDatabase_factura = new FacturaBaseHelper(getApplicationContext()).getReadableDatabase();
    ...
    private void inicializarFacturasDialog(){
        ...
        facturasDialog = new Dialog(NovoProdutoActivity.this);
